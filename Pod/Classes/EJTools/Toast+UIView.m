...
- (UIView *)makeViewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image isShadow:(BOOL)_isShadow{
    ...
    if (title != nil) {
        ...
        CGRect rect = [title boundingRectWithSize:maxSizeTitle
                                            options:NSStringDrawingUsesLineFragmentOrigin
                                         attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:titleLabel.font.pointSize]}
                                            context:nil];
        CGSize expectedSizeTitle = rect.size;
    ...
    if (message != nil) {
        ...
        CGRect rect = [message boundingRectWithSize:maxSizeMessage
                                          options:NSStringDrawingUsesLineFragmentOrigin
                                       attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:messageLabel.font.pointSize]}
                                          context:nil];
        CGSize expectedSizeMessage = rect.size;
